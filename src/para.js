export const paraArray = [
    ...
    Nestled in the heart of [Your Region], our beekeepers work tirelessly to ensure every jar is filled with the purest, most delicious honey nature has to offer.`,
